...
class MyTestCase(unittest.TestCase):
    def test_get_img(self):
        """> validate image file."""
        result = image.get("D:/source/repos/pycolor/tests/test_files/test.jpg")
        self.assertIn("/test_files/test.jpg", result)

    def test_get_image_dir(self):
        """> validate image directory."""
        result = image.get("D:/source/repos/pycolor/tests/test_files")
        self.assertEqual(result.endswith(".jpg") or result.endswith(".png"), True)
